...
class LevelTest extends Specification
{
    ...
    {
        level.generateEntities(player,enemyList,wallList)
        Bullet bullet1 = new Bullet(new Position(1, 1), new HandCannon(), 'S' as char, true, 'b' as char)
        Bullet bullet2 = new Bullet(new Position(5, 5), new HandCannon(), 'N' as char, true, 'b' as char)
        Bullet bullet3 = new Bullet(new Position(5, 3), new HandCannon(), 'W' as char, true, 'b' as char)
        Bullet bullet4 = new Bullet(new Position(5, 6), new HandCannon(), 'E' as char, true, 'b' as char)
    ...
    {
        level.generateEntities(player,enemyList,wallList)
        Bullet bullet1 = new Bullet(new Position(1, 1), new HandCannon(), 'N' as char, true, 'b' as char)
        Bullet bullet2 = new Bullet(new Position(8, 5), new HandCannon(), 'N' as char, true, 'b' as char)
        Bullet bullet3 = new Bullet(new Position(8, 3), new HandCannon(), 'N' as char, true, 'b' as char)
        level.addBullet(bullet1)
        level.addBullet(bullet2)
        level.addBullet(bullet3)
        when:
